...
{
  public sealed class Creature2 : MonoBehaviour, IStatOwner, IKeyValueStoreOwner
  {
    ...
    void Update()
    {
      ...
      _attachmentDisplay.SetStatusEffects(new DelegateContext(_registry), _data.Stats.StatusEffects);
    }
    ...
    void Invoke(IEventData data)
    {
      ...
      while (true)
      {
        ...
        foreach (var effect in effects)
        {
          ...
          // foreach (var eventData in effect.Events(null!)!.Value.Item2)
          // {
