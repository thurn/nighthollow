...
{
  public sealed class FireProjectileEffect : IEffect
  {
    ...
    public Description Describe => new Description("fire a projectile");
    ...
    {
      DOTween.Sequence().InsertCallback(FiringDelayMs / 1000f, () => FireAsync(injector));
    }
    ...
    void FireAsync(EffectInjector injector)
    {
      var projectile = injector.Get(Key.AssetService).InstantiatePrefab<Projectile>(
